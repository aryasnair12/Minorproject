...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	if(mysql_num_rows($s)==0)
	    echo "<b><br><font color='red' size='5'>No Notice waiting for approval";
	else
	{
	   ...
	   if($s1==$row[0])
	   	   echo "<tr align='center' bgcolor='#aabbcc'><td>$row[0]</td><td>$row[2]</td><td>$row[3]</td><td>Processed</td></tr>";
	   else
    ...
    <td valign="top"><form name="form1" method="post" action="noticeapproval3.php">
      <table width="200" border="0">
        ...
        <tr>
		  ...
		  $s="update notice set appstatus='$s2',appdate='$appdate' where nno=$s1";
		  mysql_query($s);
		  if($s2=="Y")
		  echo "<b><font color='red' size='5'>Approved....";
		  else
		  echo "<b><font color='red' size='5'>Rejected....";
