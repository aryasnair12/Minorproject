...
<table width="1318" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="1220" rowspan="2" valign="top"><p><strong>Staff List (Office-Staff) </strong></p>      <p>
        <?php
	include("connection.php");
	$s=mysql_query("select * from staff  where stype='O'");
    ...
    &nbsp; </p></td>
    <td width="18">&nbsp;</td>
    <td width="43" valign="top"><input type="submit" name="Submit" value="Print" onClick="printf()"></td>
  </tr>
  <tr>
    <td height="363">&nbsp;</td>
    <td>&nbsp;</td>
