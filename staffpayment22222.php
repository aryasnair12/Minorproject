...
<table width="1311" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   ?>   <table width="261" border="1">
    ...
    <td>&nbsp;</td>
    <td valign="top"><p><strong>Fees Payment (Exam Fees) </strong></p>
      <form name="form1" onSubmit="return abc()" method="post" action="staffpayment33333.php">
        <table width="471" border="0">
          <tr>
            <td width="179">Pay Amount </td>
            <td width="276"><?php echo $a5; ?></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
