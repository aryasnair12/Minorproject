        ...
        <table width="471" border="0">
          ...
          <tr>
            ...
            <td><?php
			   ...
			   $s="insert into payment (payno,admno,cname,paytype,paydate,amount,staffid) values($payno,'$admno','$cname','sinst','$paydate', $a3,'$staffid')";
			   mysql_query($s);
