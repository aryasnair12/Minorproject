        ...
        <table width="471" border="0">
          ...
          <tr>
            ...
            <td><?php
			   ...
			   $s="insert into payment (payno,admno,cname,paytype,paydate,amount,staffid) values($payno,'$admno','$cname','tinst','$paydate', $a4,'$staffid')";
			   mysql_query($s);
