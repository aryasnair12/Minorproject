...
<table width="1320" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="415" valign="top"><div align="center">
        ...
        <form name="form1" method="post"  onSubmit="return abc()"action="staffchangepass2.php"><?php
	  $s1=$_POST["t1"];
	  $s2=$_POST["t2"];
	  $s3=$_POST["t3"];
	   ?>
          <table width="312" border="0">
			...
			$s=mysql_query("select * from login where userid='$admno' and  password='$s1'");
			$a=0;
			...
			{
			$s="update login set password='$s2'  where userid='$admno'";
			mysql_query($s);
